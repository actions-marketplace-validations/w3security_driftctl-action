...
jobs:
  test:
    ...
    steps:
      ...
      - name: Run driftctl
        uses: w3security/driftctl-action@v1
        with:
          version: 0.38.2
```
...
You will also need to agree to the [Contributor Agreement](https://gist.github.com/w3securitysec/201fc2fd188b4a68973998ec30b57686) before the code can be accepted and merged.
